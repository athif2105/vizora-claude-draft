...
import { getUserFunnels, SavedFunnel, deleteFunnel, renameFunnel } from '@/services/funnel.service';
import { FileText, Loader2, X, Edit2, Check } from 'lucide-react';
        ...
        {loading ? (
          ...
          <div className="text-center py-8">
            ...
            <p className="text-xs text-gray-400 dark:text-gray-600 mt-1">
              Import and save a funnel to see it here
            </p>
          </div>
        )}
      </div>
